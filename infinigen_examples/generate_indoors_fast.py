...
from infinigen.core import execute_tasks, init, placement, surface  # noqa: F401
...
def compose_indoors(output_folder: Path, scene_seed: int, **overrides):
    ...
    solved_bound_points = np.concatenate([butil.bounds(r) for r in solved_rooms])  # noqa: F841
    """solved_bbox = (
